...
import { Text, Heading, Card, CardHeader, CardBody, Flex, Link, Box } from '@polysky-libs/uikit'
            ...
            <FoldableText title={t('Step 1: Submit application')} mt="24px">
              <Box display="inline">
                <Text display="inline" color="textSubtle">
                  {t('Projects can submit an application to sponsor a yield farm and/or pool on PolyskySwap via the ')}
                </Text>
            ...
            <FoldableText title={t('Step 2: Await whitelisting')} mt="24px">
              <Box color="textSubtle">
                <Text color="textSubtle" mb="4px">
                  {t('The PolyskySwap team will try to respond within a week.')}
                </Text>
                <List>
                  <FaqLi>
                    {t(
          ...
          <CardBody>
            <Flex flexDirection="column">
              ...
              <List>
                <li>
                  {t(
                    'A project being whitelisted for participation in an auction by PolyskySwap is in no way an endorsement or recommendation about said project.',
                  )}
                </li>
                <li>
                  {t('PolyskySwap strongly advise against sending funds to any projects which request donations.')}
                </li>
                <li>
                  {t(
                    'PolyskySwap reserves all rights to remove any project it deems to have acted with malicious or dangerous intent from auctions at any time.',
                  )}
                </li>
              </List>
            </Flex>
