...
import { Button, Heading, Text, Flex, Link } from '@polysky-libs/uikit'
        ...
        <Flex flexDirection={['column-reverse', 'row']}>
          <Left>
            ...
            <Text bold fontSize="16px" color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid CAKE for the right to host a 7-day Farm on PolyskySwap.')}
            </Text>
